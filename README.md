...
- t\*\*est stability over  time \*\*:  i would  check  is  insight **stays the same over time**. If the algorithm says something today (for example, _“_ Users aged over 50 spend around 70% of their time watching spiritual content”\_), it should say **almost the same thing next week or next month** when using new but similar data.
...
- \*\*Correlation vs Causation \*\*:  Just because **two things happen together**, it does **not** mean one causes the other.
  ...
  > statement "Users aged over 50 spend around 70% of their time watching spiritual content"
